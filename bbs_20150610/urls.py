...
from apps.district import urls as district_urls
from apps.forum import urls as forum_urls
...
urlpatterns = [
    ...
    url(r'^api/', include(question_urls.api.urls
                          +tag_urls.api.urls
                          +attachment_urls.api.urls
                          +account_urls.api.urls
                          +article_urls.api.urls
                          +notifications_urls.api.urls
                          +district_urls.api.urls
                          +forum_urls.api.urls
                          )),
